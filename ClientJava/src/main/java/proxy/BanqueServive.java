 ...
 * 
 */
@WebService(name = "BanqueServive", targetNamespace = "http://ws/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface BanqueServive {
    ...
    @Action(input = "http://ws/BanqueServive/ConvertRequest", output = "http://ws/BanqueServive/ConvertResponse")
    ...
    @Action(input = "http://ws/BanqueServive/getCompteRequest", output = "http://ws/BanqueServive/getCompteResponse")
    ...
    @Action(input = "http://ws/BanqueServive/listComptesRequest", output = "http://ws/BanqueServive/listComptesResponse")
