 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:9999/BanqueServive?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9999/BanqueServive?wsdl");
     ...
     * 
     * @return
     *     returns BanqueServive
     */
    @WebEndpoint(name = "BanqueServivePort")
    public BanqueServive getBanqueServivePort() {
        return super.getPort(new QName("http://ws/", "BanqueServivePort"), BanqueServive.class);
    }
     ...
     */
    @WebEndpoint(name = "BanqueServivePort")
    public BanqueServive getBanqueServivePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "BanqueServivePort"), BanqueServive.class, features);
    }
